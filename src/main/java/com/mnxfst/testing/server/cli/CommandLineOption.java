...
public class CommandLineOption {
	...
	public CommandLineOption(String commandLineOption,
			String commandLineOptionShort, boolean required,
			boolean argumentProvided, Class<? extends Serializable> valueClass,
			String description, String valueMapName, String missingValueMessage) {
	...
	public Option asCliOption() {
		return new Option(commandLineOptionShort, commandLineOption,
				argumentProvided, description);
	}
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("missingValueMessage", this.missingValueMessage)
				.toString();
	}
